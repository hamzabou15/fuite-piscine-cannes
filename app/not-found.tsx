      ...
      <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex items-center justify-center">
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, rgba(17,72,119,0.05), rgba(255,215,0,0.05))",
              width: "100%",
              maxWidth: 520,
            }}
          >
            <svg viewBox="0 0 520 360" width="100%" height="100%" aria-hidden>
              <defs>
                <linearGradient id="g1" x1="0" x2="1" y1="0" y2="1">
                  <stop offset="0%" stopColor="#114877" stopOpacity="0.9" />
        ...
        <div className="flex flex-col justify-center gap-6">
          ...
          <p className="text-gray-700 max-w-xl">
            Il se peut que l&apos;adresse ait changé ou que la page ait été
            supprimée. Pas de panique — nous intervenons encore plus vite
            qu&apos;une équipe de dépannage !
          </p>

          <div className="flex flex-wrap gap-3 mt-2">
            <Link
              href="/"
              style={{ backgroundColor: "#114877", color: "#fff" }}
            ...
            <Link
              ...
              className="inline-flex items-center justify-center px-5 py-3 rounded-md text-sm font-medium hover:bg-[#FFFBEA] transition"
            ...
            <a
              ...
              style={{ backgroundColor: "#FFD700", color: "#114877" }}
            >
          ...
          <p className="text-xs text-gray-500 mt-4">
            Si le problème persiste, contacte-nous via la page contact — on
            s&apos;occupe du reste.
          </p>
        </div>
      </div>
