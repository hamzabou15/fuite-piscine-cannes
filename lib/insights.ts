export const insights = [
  {
    ...
    <p class="mb-8 text-[#4d5562]">
      À l’issue de l’intervention, un <strong>rapport d’intervention détaillé</strong> vous est remis, documentant la technique utilisée, les résultats et recommandations pour vos démarches d’assurance ou de prise en charge.
    </p>
    <p class="mb-8 text-[#4d5562]">
      Contactez-nous dès aujourd’hui pour un devis clair et personnalisé pour toute recherche de fuite sur piscine béton dans les Alpes‑Maritimes.
    </p>
  `
...
<p class="mb-8 text-[#4d5562]">
  ...
  },
  {
    ...
    description: `
      <p class="mb-8  text-[#4d5562]">
        Entièrement spécialisé dans la <strong>recherche de fuite non destructive</strong> sur piscines à coque dans les Alpes‑Maritimes (06), notre équipe intervient à Peymeinade suite à une baisse rapide du niveau d’eau de la piscine.
      </p>
      <p class="mb-8  text-[#4d5562]">
        À notre arrivée, nous avons procédé à une mise en pression de tous les réseaux sans résultat. Nous avons ensuite testé les pièces à sceller via la coque, la bonde de fond ainsi que la cuve submersible, jusqu’à détecter une fuite sur le raccord de vidange inférieur.
      </p>
      <p class="mb-8  text-[#4d5562]">
        Grâce à nos équipements de pointe (<em>caméra étanche</em>, <em>électro‑acoustique</em>, <em>gaz traceur</em>, <em>fluorescéine</em>), nous garantissons une localisation précise sans casse. Idéal pour ne pas endommager le bassin ni ses finitions.
      </p>
      <p class="mb-8  text-[#4d5562]">
  ...
  {
    slug: "fuite-piscine-beton-antibes-biot",
    title: "Recherche de fuite sur piscine béton à Antibes près de Biot (06)",
    img: "/images/fuite-piscine-beton-antibes-biot.webp",
    imgAlt: "Recherche de fuite sur piscine béton à Antibes près de Biot (06)",
    description: `
    <p class="mb-8  text-[#4d5562]">
      Vous avez remarqué une baisse anormale du niveau d'eau dans votre piscine à débordement à Antibes (près de Biot, 06) ? Notre intervention a permis de localiser une fuite structurelle très précise.
    </p>
    <p class="mb-8  text-[#4d5562]">
      Le client constatait une perte d’eau d’environ <strong>1,5 cm de niveau par jour</strong> sur le bac tampon. Nous avons réalisé une <strong>mise en pression de la bonde de fond</strong> et du circuit du remplissage automatique, sans résultats. Puis nous avons poursuivi l’analyse sur les parties structurelles.
    </p>
    <p class="mb-8  text-[#4d5562]">
      C’est ainsi que nous avons identifié <strong>deux fuites structurelles dans le béton</strong> de la piscine. Grâce à nos équipements non destructifs (fluorescéine, électro-acoustique, caméra thermique), la localisation a été extrêmement précise, sans endommager votre installation.
    </p>
    <p class="mb-8  text-[#4d5562]">
      Après diagnostic, nous vous proposons un <strong>rapport d’intervention détaillé</strong> avec plan de réparation adapté. Nous pouvons également prendre en charge la réparation ciblée pour rétablir l’étanchéité complète.
    </p>
    <p class="mb-8  text-[#4d5562]">
      Contactez-nous pour obtenir un devis rapide ou échanger sur une intervention professionnelle, fiable et durable pour votre piscine à Antibes ou dans les environs.
    </p>
  `
  }
  ,
  {
    slug: "fuite-piscine-coque-vallauris",
    title: "Recherche de fuite d'eau sur une piscine coque à Vallauris dans les Alpes Maritimes",
    img: "/images/fuite-piscine-coque-vallauris.webp",
    imgAlt: "Recherche de fuite d'eau sur une piscine coque à Vallauris dans les Alpes Maritimes",
    description: `
    <p class="mb-8  text-base font-normal text-[var(--color-pool-muted)] mb-6">
      L’entreprise <strong>Fuite Piscine Expert</strong> a été appelée pour intervenir sur une piscine coque à Vallauris (06), suite à une baisse de niveau d’eau anormalement rapide. À notre arrivée, nous avons procédé à un contrôle minutieux des pièces à sceller : skimmers, buses de refoulement et bonde de fond.
    </p>
    <p class="mb-8  text-base font-normal text-[var(--color-pool-muted)] mb-6">
      Une mise en pression des réseaux (skimmer, refoulement, bonde de fond) n’a rien révélé d’anormal. Nous avons donc utilisé une caméra endoscopique dans le skimmer, permettant de localiser la fuite avec une précision maximale.
    </p>
    <p class="mb-8  text-base font-normal text-[var(--color-pool-muted)] mb-6">
  ...
  ,
  {
    ...
    <p class="mb-8  text-[#4d5562]">
      Grâce à notre savoir‑faire et équipements modernes (mise en pression, test d’étanchéité, inspection non destructive), nous avons repéré la fuite localisée au niveau du scellement de la bonde.
    </p>
    <p class="mb-8  text-[#4d5562]">
      Notre équipe vous accompagne ensuite jusqu’à la <strong>réparation ciblée</strong> et la <strong>remise en eau</strong> de votre piscine. Un <strong>rapport d’intervention détaillé</strong> est fourni, avec des photos et une analyse technique – indispensable pour le suivi ou la prise en charge assurance.
    </p>
    <p class="mb-8  text-[#4d5562]">
      Contactez-nous pour un diagnostic rapide de <strong>fuite piscine béton</strong> dans le 06, un <strong>devis gratuit personnalisé</strong> ou une prise en charge efficace.
    </p>
  `
  }
  ,
  {
    ...
    description: `
      ...
      À notre arrivée, nous avons effectué un contrôle minutieux des pièces à sceller ainsi que de l’étanchéité autour des skimmers et des buses de refoulement. Ces éléments sont souvent sources de fuites sur les piscines coques.
    </p>
       <p class="mb-8  text-[#4d5562]">

      Nous avons ensuite procédé à une mise en pression complète du circuit hydraulique afin de détecter toute fuite invisible à l’œil nu. Cette méthode permet d’isoler précisément la zone défectueuse sans endommager la structure de la piscine.
    </p>
       <p class="mb-8  text-[#4d5562]">

      Notre équipe utilise des technologies de pointe, telles que la caméra thermique et la fluorescéine, pour localiser la fuite rapidement et efficacement. Une fois la fuite identifiée, nous proposons une solution adaptée pour la réparation durable.
    </p>
       <p class="mb-8  text-[#4d5562]">

      Après intervention, nous assurons un suivi rigoureux afin de vérifier la bonne étanchéité et le rétablissement optimal du niveau d’eau. Un rapport détaillé est également fourni, essentiel pour les démarches auprès des assurances.
    </p>
       <p class="mb-8  text-[#4d5562]">
